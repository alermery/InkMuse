...
export default function CharacterPage() {
  ...
  const [gender, setGender] = usePersistedState("inkmuse:character:gender", "");
  const [identity, setIdentity] = usePersistedState("inkmuse:character:identity", "");
  const [role, setRole] = usePersistedState("inkmuse:character:role", ["主角"]);
  const [traits, setTraits] = usePersistedState<string[]>("inkmuse:character:traits", []);
  const [question, setQuestion] = usePersistedState("inkmuse:character:question", "");
  const [profile, setProfile] = usePersistedState("inkmuse:character:profile", "");
  const [interview, setInterview] = usePersistedState("inkmuse:character:interview", "");
